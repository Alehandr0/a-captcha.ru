...
if(!isset($_SESSION['kap4a'])||!isset($_SESSION['Ol']))
  {
	echo"<meta http-equiv=Refresh content='0; url=http://{$_SERVER['HTTP_HOST']}/dopolnenie/kap4a/z__example.php'>";
	$hid4a=1; require_once("../dopolnenie/kap4a/z__example.php"); exit;
}
?>
<form method=POST>
<p>Введите текст, показанный ниже:</p>
<p><img src="http://<?=$_SERVER['HTTP_HOST']?>/dopolnenie/kap4a/index.php?s&c&r=5"></p>
